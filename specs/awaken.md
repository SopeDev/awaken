...
See `AvatarSystem.md` for the full, updated AI-driven avatar mechanics.

<!-- LEGACY (outdated): see AvatarSystem.md for updated mechanics.
...
See `AwarenessSystem.md` for the current awareness-meter computation and LLM-driven factors.

<!-- LEGACY (outdated): see AwarenessSystem.md for updated mechanics.
...
See `specs/CosmicBlueprintSystem.md` for the full specification.
...
See `NeedsSystem.md` for the current need-state update loop and LLM natural-language conversion.

<!-- LEGACY (outdated): see NeedsSystem.md for updated mechanics.
